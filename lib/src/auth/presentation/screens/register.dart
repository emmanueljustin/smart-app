      ...
      child: Scaffold(
        ...
        body: BlocListener<RegisterBloc, RegisterState>(
          listener: (context, registerState) {
            if (registerState.status == RegisterStatus.loading) {
              context.loaderOverlay.show();
            }

            if (registerState.status == RegisterStatus.failed) {
          ...
          child: BlocBuilder<WidgetsHelperCubit<String?>, String?>(
                                  ...
                                  Container(
                                    ...
                                    child: DropdownButtonHideUnderline(
                                      child: DropdownButton<String>(
                                        ...
                                        icon: selectedGender == null ? null : Icon(selectedGender == 'Male' ? Icons.male : Icons.female),
                                ...
                                onPressed: () {
                                  if (_key.currentState!.validate() && selectedGender != null) {
                                    context.read<RegisterBloc>().add(
                                          CreateAccount(
                                            RegisterParams(username: _username.text, password: _password.text, email: _email.text, firstName: _firstName.text, lastName: _lastName.text, gender: selectedGender, age: int.tryParse(_age.text) ?? 0),
                                          ),
                                        );
                                  }
                                },
